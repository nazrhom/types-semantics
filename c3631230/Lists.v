...
Lemma rev_cons_rewrite :  forall l: natlist, forall n:nat, 
...
Proof.
 ...
 Case "l = nil".
    reflexivity.
  Case "l = cons n l1'".
    simpl. rewrite -> rev_cons_rewrite.
    rewrite -> IHl'. reflexivity. Qed.
...
Lemma snoc_dist : forall l1 l2 : natlist, forall n : nat,
...
Proof.
  ...
  Case "l1 = cons n' l1'".
    simpl. rewrite IHl1'.
    rewrite -> snoc_dist. reflexivity. Qed.
...
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  ...
  | h :: t => match l2 with
          | nil => false
          | h2 :: t2 => (beq_nat h h2) /\ (beq_natlist t t2)
          end
  end.
